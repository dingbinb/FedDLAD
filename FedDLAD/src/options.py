...
def args_parser():
    ...
    parser.add_argument('--train_rounds', type=int, default=300,
    ...
    parser.add_argument('--attack_round', type=int, default= 80,
                        help="start attacking from round(single-shot)")

    parser.add_argument('--attack_interval', type=int, default=2,
    ...
    parser.add_argument('--defense', type=str, default='SnowBall',
    ...
    #FedDLAD settings
    #COF
    parser.add_argument('--bg', type=int, default=13, help="benign group size")
    #IQR
    parser.add_argument('--iqr_scale', type=float, default=1.5, help='scale factor for IQR-based outlier thresholding')
    #Pardoned
